...
/**
 * Hardcore pie chart. Draws cake like slices with different radii.
 *
 * @author CarbonylGroup based on the work of Philipp Jahoda
 */
public class PieRadarChart extends PieRadarChartBase<PieData> {
    ...
    /**
     * array list that holds the radius of each pie-slice
     */
    private ArrayList<Pair<Float, Float>> mDrawRadiiPairs = new ArrayList<>();
    ...
    protected int innerLabelColor = Color.WHITE;
    ...
    public PieRadarChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new PieRadarChartRenderer(this, mAnimator, mViewPortHandler);
        mXAxis = null;

        mHighlighter = new PieRadarHighlighter(this);
    }
    ...
    public RectF getCircleBoxWithRadius(float radius) {
     ...
     * @return
     */
    public Float getDrawRadius(int index) {
        if (mCircleBox == null || index < 0)
            return 0f;
        else
            return Math.min(mCircleBox.width() / 2f, mCircleBox.height() / 2f)
                    * (mDrawRadiiPairs.get(index).first / mDrawRadiiPairs.get(index).second);
    }

    public Float getDrawRadii(int index) {
        if (index < 0)
            return 0f;
        else
            return mDrawRadiiPairs.get(index).first / mDrawRadiiPairs.get(index).second;
    }

    public Pair<Float, Float> getDrawRadiiPair(int index) {
        if (index < 0)
            return Pair.create(0f, 0f);
        else
            return mDrawRadiiPairs.get(index);
    }
    ...
    public void setHoleColor(int color) {
        ((PieRadarChartRenderer) mRenderer).getPaintHole().setColor(color);
    }

    public void setDrawRadiiPairs(ArrayList<Pair<Float, Float>> pairs) {
        mDrawRadiiPairs = pairs;
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((PieRadarChartRenderer) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((PieRadarChartRenderer) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((PieRadarChartRenderer) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setCenterTextColor(int color) {
        ((PieRadarChartRenderer) mRenderer).getPaintCenterText().setColor(color);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((PieRadarChartRenderer) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((PieRadarChartRenderer) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    public void setEntryLabelColor(int color) {
        ((PieRadarChartRenderer) mRenderer).getPaintEntryLabels().setColor(color);
    }
     ...
     * @param color
     */
    public void setEntryInnerLabelColor(int color) {
        this.innerLabelColor = color;
    }
    ...
    public void setEntryLabelTypeface(Typeface tf) {
        ((PieRadarChartRenderer) mRenderer).getPaintEntryLabels().setTypeface(tf);
    }
    ...
    public void setEntryLabelTextSize(float size) {
        ((PieRadarChartRenderer) mRenderer).getPaintEntryLabels().setTextSize(Utils.convertDpToPixel(size));
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof PieRadarChartRenderer) {
            ((PieRadarChartRenderer) mRenderer).releaseBitmap();
        }
